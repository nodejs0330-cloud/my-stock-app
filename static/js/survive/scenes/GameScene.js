class GameScene extends Phaser.Scene {
            ...
            // 인게임 HUD 및 모바일 줌인 뷰포트 내부 안착 보정
            setupUI() {
                createMuteButton(this, 'GAME');

                // [수정 3] 홈(뒤로) 버튼 모바일 뷰포트 안전 배치 (X: 130)
                ...
                // 스킬 버튼 줌인 뷰포트 우측 하단 안착 (X: scale.width - 140)
            ...
            // [수정 2] 스킬 발동 컷인을 화면 한가운데(scale.width/2) 배치하여 전신이 선명하게 노출
            useHeroActiveSkill() {
                ...
                let finalCd = Math.max(20, Math.floor(40 * cdMult));
            ...
            // [수정 4] 보스 등장 시 타이머 제거 및 상단 보스 HUD 체력바(%) 활성화
            spawnBoss() {
            ...
            // 모바일 줌인 환경 카드 세로형 피팅 (13종 전체 보상 풀 100% 보존)
